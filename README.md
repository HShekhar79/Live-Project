...
| Landing Page | Price Calculator |
|---|---|
| ![HomeAura Landing](./screenshot-hero.png) | ![Price Calculator](./screenshot-calculator.png) |

> **Left:** Hero section with the 4-step estimator flow. **Right:** Full calculator — city, BHK, area, furnishing, parking, and more — with an interactive Leaflet map and AI prediction panel.
...
| Role | Owner | What they built |
|---|---|---|
| **Project Lead** | [@shivammisra766](https://github.com/shivammisra766) | Architecture decisions, project direction, integration |
| **Backend + ML Pipeline** | [@shivammisra766](https://github.com/shivammisra766) | Express API, ML pipeline end-to-end, model serving, lead management, admin auth |
| **Frontend** | [@HShekhar79](https://github.com/HShekhar79) | React + Vite UI, BHK estimator, interior showcase, city map, reviews |
...
Built with ☕ by [@shivammisra766](https://github.com/shivammisra766) (Lead) & [@HShekhar79](https://github.com/HShekhar79) (Frontend)
